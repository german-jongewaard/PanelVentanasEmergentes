package panelventanasemergentes;
...
public class Marco_Dialogos extends JFrame {
    ...
    public Object[] dameOpciones(Lamina_Botones lamina){
        ...
        if(s.equals("String[]")){
            ...
            return new Object[]{new ImageIcon("src/imagenes/azul.gif"), 
                new ImageIcon("src/imagenes/amarilla.gif"),
                new ImageIcon("src/imagenes/roja.gif")};
    ...
    private Icon iconoMensaje = new ImageIcon("src/imagenes"
            + "/Lady_gangsta.gif");
